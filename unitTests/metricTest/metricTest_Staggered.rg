...
local function checkLeft(r, c, sdir)
   ...
   return rquote
      ...
      regentlib.assert(fabs(r[c].[reconPlus][Stencil1*6+1]      ) < 1e-8, ["metricTest: error in Left Metric on " .. reconPlus])
      regentlib.assert(fabs(r[c].[reconPlus][Stencil1*6+2] - 1.0) < 1e-3, ["metricTest: error in Left Metric on " .. reconPlus])
      regentlib.assert(fabs(r[c].[reconPlus][Stencil1*6+3]      ) < 1e-8, ["metricTest: error in Left Metric on " .. reconPlus])
      ...
      -- Stencil3
      regentlib.assert(fabs(r[c].[reconPlus][Stencil3*6+0]      ) < 1e-8, ["metricTest: error in Left Metric on " .. reconPlus])
      regentlib.assert(fabs(r[c].[reconPlus][Stencil3*6+1]      ) < 1e-8, ["metricTest: error in Left Metric on " .. reconPlus])
      regentlib.assert(fabs(r[c].[reconPlus][Stencil3*6+2] - 1.0) < 1e-3, ["metricTest: error in Left Metric on " .. reconPlus])
      ...
      regentlib.assert(fabs(r[c].[reconPlus][Stencil4*6+2] - 1.0) < 1e-3, ["metricTest: error in Left Metric on " .. reconPlus])
      regentlib.assert(fabs(r[c].[reconPlus][Stencil4*6+3]      ) < 1e-8, ["metricTest: error in Left Metric on " .. reconPlus])
      regentlib.assert(fabs(r[c].[reconPlus][Stencil4*6+4]      ) < 1e-8, ["metricTest: error in Left Metric on " .. reconPlus])
      regentlib.assert(fabs(r[c].[reconPlus][Stencil4*6+5]      ) < 1e-8, ["metricTest: error in Left Metric on " .. reconPlus])
      -- Minus side
      -- Stencil1
      ...
      regentlib.assert(fabs(r[c].[reconMinus][Stencil1*6+2] - 1.0) < 1e-3, ["metricTest: error in Left Metric on " .. reconMinus])
      regentlib.assert(fabs(r[c].[reconMinus][Stencil1*6+3]      ) < 1e-8, ["metricTest: error in Left Metric on " .. reconMinus])
      ...
      -- TENO blending coefficients
      -- Plus side
      regentlib.assert(fabs((r[c].[TENOCoeffsPlus][Stencil1]/(9.0/20.0)) - 1.0) < 1e-3, ["metricTest: error in Left Metric on " .. TENOCoeffsPlus])
      regentlib.assert(fabs((r[c].[TENOCoeffsPlus][Stencil2]/(6.0/20.0)) - 1.0) < 1e-3, ["metricTest: error in Left Metric on " .. TENOCoeffsPlus])
      regentlib.assert(fabs((r[c].[TENOCoeffsPlus][Stencil3]/(1.0/20.0)) - 1.0) < 1e-3, ["metricTest: error in Left Metric on " .. TENOCoeffsPlus])
      regentlib.assert(fabs((r[c].[TENOCoeffsPlus][Stencil4]/(4.0/20.0)) - 1.0) < 1e-3, ["metricTest: error in Left Metric on " .. TENOCoeffsPlus])
      -- Minus side
      regentlib.assert(fabs((r[c].[TENOCoeffsMinus][Stencil1]/(9.0/20.0)) - 1.0) < 1e-3, ["metricTest: error in Left Metric on " .. TENOCoeffsMinus])
      regentlib.assert(fabs((r[c].[TENOCoeffsMinus][Stencil2]/(6.0/20.0)) - 1.0) < 1e-3, ["metricTest: error in Left Metric on " .. TENOCoeffsMinus])
      regentlib.assert(fabs((r[c].[TENOCoeffsMinus][Stencil3]/(1.0/20.0)) - 1.0) < 1e-3, ["metricTest: error in Left Metric on " .. TENOCoeffsMinus])
      regentlib.assert(fabs((r[c].[TENOCoeffsMinus][Stencil4]/(4.0/20.0)) - 1.0) < 1e-3, ["metricTest: error in Left Metric on " .. TENOCoeffsMinus])
      -- BC flag
      regentlib.assert(r[c].[BCStencil] == true, ["metricTest: error in Left Metric on " .. BCStencil])
      -- Face interpolation operator
      regentlib.assert(fabs(r[c].[interp][0] - 1.0) < 1e-3, ["metricTest: error in Left Metric on " .. interp])
      regentlib.assert(fabs(r[c].[interp][1]      ) < 1e-8, ["metricTest: error in Left Metric on " .. interp])
      -- Face derivative operator
      regentlib.assert(fabs((r[c].[deriv]*r[c].cellWidth[dir]*0.5) - 1.0) < 1e-3, ["metricTest: error in Left Metric on " .. deriv])
      -- Gradient operator
      regentlib.assert(fabs((r[c].[grad][0]                        )      ) < 1e-8, ["metricTest: error in Left Metric on " .. grad])
      regentlib.assert(fabs((r[c].[grad][1]*r[c].cellWidth[dir]*0.5) - 1.0) < 1e-3, ["metricTest: error in Left Metric on " .. grad])
   end
end
...
local function checkLeftPlusOne(r, c, sdir)
   ...
   return rquote
      ...
      regentlib.assert(fabs((r[c].[reconPlus][Stencil1*6+1]/(-2.0/4.0)) - 1.0) < 1e-3, ["metricTest: error in LeftPlusOne Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil1*6+2]/( 5.0/4.0)) - 1.0) < 1e-3, ["metricTest: error in LeftPlusOne Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil1*6+3]/( 1.0/4.0)) - 1.0) < 1e-3, ["metricTest: error in LeftPlusOne Metric on " .. reconPlus])
      ...
      -- Stencil3
      regentlib.assert(fabs((r[c].[reconPlus][Stencil3*6+0]           )      ) < 1e-8, ["metricTest: error in LeftPlusOne Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil3*6+1]/(-1.0    )) - 1.0) < 1e-3, ["metricTest: error in LeftPlusOne Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil3*6+2]/( 2.0    )) - 1.0) < 1e-3, ["metricTest: error in LeftPlusOne Metric on " .. reconPlus])
      ...
      regentlib.assert(fabs((r[c].[reconMinus][Stencil2*6+1]/(-2.0/4.0)) - 1.0) < 1e-3, ["metricTest: error in LeftPlusOne Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil2*6+2]/( 5.0/4.0)) - 1.0) < 1e-3, ["metricTest: error in LeftPlusOne Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil2*6+3]/( 1.0/4.0)) - 1.0) < 1e-3, ["metricTest: error in LeftPlusOne Metric on " .. reconMinus])
      ...
      -- Stencil4
      regentlib.assert(fabs((r[c].[reconMinus][Stencil4*6+0]           )      ) < 1e-8, ["metricTest: error in LeftPlusOne Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil4*6+1]           )      ) < 1e-8, ["metricTest: error in LeftPlusOne Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil4*6+2]           ) - 1.0) < 1e-3, ["metricTest: error in LeftPlusOne Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil4*6+3]           )      ) < 1e-8, ["metricTest: error in LeftPlusOne Metric on " .. reconMinus])
      ...
      -- TENO blending coefficients
      -- Plus side
      regentlib.assert(fabs((r[c].[TENOCoeffsPlus][Stencil1]/(2.0/4.0)) - 1.0) < 1e-3, ["metricTest: error in LeftPlusOne Metric on " .. TENOCoeffsPlus])
      ...
      -- Minus side
      regentlib.assert(fabs((r[c].[TENOCoeffsMinus][Stencil1]/(7.0/16.0)) - 1.0) < 1e-3, ["metricTest: error in LeftPlusOne Metric on " .. TENOCoeffsMinus])
      regentlib.assert(fabs((r[c].[TENOCoeffsMinus][Stencil2]/(8.0/16.0)) - 1.0) < 1e-3, ["metricTest: error in LeftPlusOne Metric on " .. TENOCoeffsMinus])
      regentlib.assert(fabs((r[c].[TENOCoeffsMinus][Stencil3]/(1.0/16.0)) - 1.0) < 1e-3, ["metricTest: error in LeftPlusOne Metric on " .. TENOCoeffsMinus])
      ...
      -- Gradient operator
      regentlib.assert(fabs((r[c].[grad][0]*r[c].cellWidth[dir]    ) - 1.0) < 1e-3, ["metricTest: error in LeftPlusOne Metric on " .. grad])
...
local function checkLeftPlusTwo(r, c, sdir)
   ...
   return rquote
      ...
      -- Plus side
      -- Stencil1
      regentlib.assert(fabs((r[c].[reconPlus][Stencil1*6+0]           )      ) < 1e-8, ["metricTest: error in LeftPlusTwo Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil1*6+1]/(-1.0/6.0)) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil1*6+2]/( 5.0/6.0)) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil1*6+3]/( 2.0/6.0)) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil1*6+4]           )      ) < 1e-8, ["metricTest: error in LeftPlusTwo Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil1*6+5]           )      ) < 1e-8, ["metricTest: error in LeftPlusTwo Metric on " .. reconPlus])
      -- Stencil2
      regentlib.assert(fabs((r[c].[reconPlus][Stencil2*6+0]           )      ) < 1e-8, ["metricTest: error in LeftPlusTwo Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil2*6+1]           )      ) < 1e-8, ["metricTest: error in LeftPlusTwo Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil2*6+2]/( 2.0/6.0)) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil2*6+3]/( 5.0/6.0)) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil2*6+4]/(-1.0/6.0)) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil2*6+5]           )      ) < 1e-8, ["metricTest: error in LeftPlusTwo Metric on " .. reconPlus])
      -- Stencil3
      regentlib.assert(fabs((r[c].[reconPlus][Stencil3*6+0]/( 1.0    )) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil3*6+1]/(-2.0    )) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil3*6+2]/( 2.0    )) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil3*6+3]           )      ) < 1e-8, ["metricTest: error in LeftPlusTwo Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil3*6+4]           )      ) < 1e-8, ["metricTest: error in LeftPlusTwo Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil3*6+5]           )      ) < 1e-8, ["metricTest: error in LeftPlusTwo Metric on " .. reconPlus])
      -- Stencil4
      regentlib.assert(fabs((r[c].[reconPlus][Stencil4*6+0]           )      ) < 1e-8, ["metricTest: error in LeftPlusTwo Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil4*6+1]           )      ) < 1e-8, ["metricTest: error in LeftPlusTwo Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil4*6+2]/( 3.0/12.0))- 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil4*6+3]/(13.0/12.0))- 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil4*6+4]/(-5.0/12.0))- 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil4*6+5]/( 1.0/12.0))- 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. reconPlus])
      -- Minus side
      -- Stencil1
      regentlib.assert(fabs((r[c].[reconMinus][Stencil1*6+0]           )      ) < 1e-8, ["metricTest: error in LeftPlusTwo Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil1*6+1]           )      ) < 1e-8, ["metricTest: error in LeftPlusTwo Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil1*6+2]/( 2.0/6.0)) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil1*6+3]/( 5.0/6.0)) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil1*6+4]/(-1.0/6.0)) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil1*6+5]           )      ) < 1e-8, ["metricTest: error in LeftPlusTwo Metric on " .. reconMinus])
      -- Stencil2
      regentlib.assert(fabs((r[c].[reconMinus][Stencil2*6+0]           )      ) < 1e-8, ["metricTest: error in LeftPlusTwo Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil2*6+1]/(-1.0/6.0)) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil2*6+2]/( 5.0/6.0)) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil2*6+3]/( 2.0/6.0)) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil2*6+4]           )      ) < 1e-8, ["metricTest: error in LeftPlusTwo Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil2*6+5]           )      ) < 1e-8, ["metricTest: error in LeftPlusTwo Metric on " .. reconMinus])
      -- Stencil3
      regentlib.assert(fabs((r[c].[reconMinus][Stencil3*6+0]           )      ) < 1e-8, ["metricTest: error in LeftPlusTwo Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil3*6+1]           )      ) < 1e-8, ["metricTest: error in LeftPlusTwo Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil3*6+2]           )      ) < 1e-8, ["metricTest: error in LeftPlusTwo Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil3*6+3]/(11.0/6.0)) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil3*6+4]/(-7.0/6.0)) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil3*6+5]/( 2.0/6.0)) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. reconMinus])
      -- Stencil4
      regentlib.assert(fabs((r[c].[reconMinus][Stencil4*6+0]/( 3.0/9.0)) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil4*6+1]/(-7.0/9.0)) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil4*6+2]/(11.0/9.0)) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil4*6+3]/( 2.0/9.0)) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil4*6+4]           )      ) < 1e-8, ["metricTest: error in LeftPlusTwo Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil4*6+5]           )      ) < 1e-8, ["metricTest: error in LeftPlusTwo Metric on " .. reconMinus])
      -- TENO blending coefficients
      -- Plus side
      regentlib.assert(fabs((r[c].[TENOCoeffsPlus][Stencil1]/4.7000e-01) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. TENOCoeffsPlus])
      regentlib.assert(fabs((r[c].[TENOCoeffsPlus][Stencil2]/2.7000e-01) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. TENOCoeffsPlus])
      ...
      -- Minus side
      regentlib.assert(fabs((r[c].[TENOCoeffsMinus][Stencil1]/3.9000e-01) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. TENOCoeffsMinus])
      regentlib.assert(fabs((r[c].[TENOCoeffsMinus][Stencil2]/2.7000e-01) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. TENOCoeffsMinus])
      regentlib.assert(fabs((r[c].[TENOCoeffsMinus][Stencil3]/4.0000e-02) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. TENOCoeffsMinus])
      regentlib.assert(fabs((r[c].[TENOCoeffsMinus][Stencil4]/3.0000e-01) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. TENOCoeffsMinus])
      -- BC flag
      regentlib.assert(r[c].[BCStencil] == true, ["metricTest: error in LeftPlusTwo Metric on " .. BCStencil])
      -- Face interpolation operator
      regentlib.assert(fabs((r[c].[interp][0]*2.0) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. interp])
      regentlib.assert(fabs((r[c].[interp][1]*2.0) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. interp])
      -- Face derivative operator
      regentlib.assert(fabs((r[c].[deriv]*r[c].cellWidth[dir]) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. deriv])
      -- Gradient operator
      regentlib.assert(fabs((r[c].[grad][0]*r[c].cellWidth[dir]*2.0) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. grad])
      regentlib.assert(fabs((r[c].[grad][1]*r[c].cellWidth[dir]*2.0) - 1.0) < 1e-3, ["metricTest: error in LeftPlusTwo Metric on " .. grad])
   end
end
...
local function checkRightMinusThree(r, c, sdir)
   ...
   return rquote
      ...
      -- Plus side
      -- Stencil1
      regentlib.assert(fabs((r[c].[reconPlus][Stencil1*6+0]           )      ) < 1e-8, ["metricTest: error in RightMinusThree Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil1*6+1]/(-1.0/6.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil1*6+2]/( 5.0/6.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil1*6+3]/( 2.0/6.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil1*6+4]           )      ) < 1e-8, ["metricTest: error in RightMinusThree Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil1*6+5]           )      ) < 1e-8, ["metricTest: error in RightMinusThree Metric on " .. reconPlus])
      -- Stencil2
      regentlib.assert(fabs((r[c].[reconPlus][Stencil2*6+0]           )      ) < 1e-8, ["metricTest: error in RightMinusThree Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil2*6+1]           )      ) < 1e-8, ["metricTest: error in RightMinusThree Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil2*6+2]/( 2.0/6.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil2*6+3]/( 5.0/6.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil2*6+4]/(-1.0/6.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil2*6+5]           )      ) < 1e-8, ["metricTest: error in RightMinusThree Metric on " .. reconPlus])
      -- Stencil3
      regentlib.assert(fabs((r[c].[reconPlus][Stencil3*6+0]/( 2.0/6.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil3*6+1]/(-7.0/6.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil3*6+2]/(11.0/6.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil3*6+3]           )      ) < 1e-8, ["metricTest: error in RightMinusThree Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil3*6+4]           )      ) < 1e-8, ["metricTest: error in RightMinusThree Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil3*6+5]           )      ) < 1e-8, ["metricTest: error in RightMinusThree Metric on " .. reconPlus])
      -- Stencil4
      regentlib.assert(fabs((r[c].[reconPlus][Stencil4*6+0]           )      ) < 1e-8, ["metricTest: error in RightMinusThree Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil4*6+1]           )      ) < 1e-8, ["metricTest: error in RightMinusThree Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil4*6+2]/( 2.0/9.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil4*6+3]/(11.0/9.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil4*6+4]/(-7.0/9.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil4*6+5]/( 3.0/9.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. reconPlus])
      -- Minus side
      -- Stencil1
      regentlib.assert(fabs((r[c].[reconMinus][Stencil1*6+0]           )      ) < 1e-8, ["metricTest: error in RightMinusThree Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil1*6+1]           )      ) < 1e-8, ["metricTest: error in RightMinusThree Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil1*6+2]/( 2.0/6.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil1*6+3]/( 5.0/6.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil1*6+4]/(-1.0/6.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil1*6+5]           )      ) < 1e-8, ["metricTest: error in RightMinusThree Metric on " .. reconMinus])
      -- Stencil2
      regentlib.assert(fabs((r[c].[reconMinus][Stencil2*6+0]           )      ) < 1e-8, ["metricTest: error in RightMinusThree Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil2*6+1]/(-1.0/6.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil2*6+2]/( 5.0/6.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil2*6+3]/( 2.0/6.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil2*6+4]           )      ) < 1e-8, ["metricTest: error in RightMinusThree Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil2*6+5]           )      ) < 1e-8, ["metricTest: error in RightMinusThree Metric on " .. reconMinus])
      -- Stencil3
      regentlib.assert(fabs((r[c].[reconMinus][Stencil3*6+0]           )      ) < 1e-8, ["metricTest: error in RightMinusThree Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil3*6+1]           )      ) < 1e-8, ["metricTest: error in RightMinusThree Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil3*6+2]           )      ) < 1e-8, ["metricTest: error in RightMinusThree Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil3*6+3]/( 2.0    )) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil3*6+4]/(-2.0    )) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil3*6+5]/( 1.0    )) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. reconMinus])
      -- Stencil4
      regentlib.assert(fabs((r[c].[reconMinus][Stencil4*6+0]/( 1.0/12.0))- 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil4*6+1]/(-5.0/12.0))- 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil4*6+2]/(13.0/12.0))- 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil4*6+3]/( 3.0/12.0))- 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil4*6+4]           )      ) < 1e-8, ["metricTest: error in RightMinusThree Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil4*6+5]           )      ) < 1e-8, ["metricTest: error in RightMinusThree Metric on " .. reconMinus])
      -- TENO blending coefficients
      -- Plus side
      regentlib.assert(fabs((r[c].[TENOCoeffsPlus][Stencil1]/3.9000e-01) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. TENOCoeffsPlus])
      regentlib.assert(fabs((r[c].[TENOCoeffsPlus][Stencil2]/2.7000e-01) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. TENOCoeffsPlus])
      ...
      regentlib.assert(fabs((r[c].[TENOCoeffsPlus][Stencil4]/3.0000e-01) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. TENOCoeffsPlus])
      -- Minus side
      regentlib.assert(fabs((r[c].[TENOCoeffsMinus][Stencil1]/4.7000e-01) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. TENOCoeffsMinus])
      regentlib.assert(fabs((r[c].[TENOCoeffsMinus][Stencil2]/2.7000e-01) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. TENOCoeffsMinus])
      regentlib.assert(fabs((r[c].[TENOCoeffsMinus][Stencil3]/1.0000e-01) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. TENOCoeffsMinus])
      regentlib.assert(fabs((r[c].[TENOCoeffsMinus][Stencil4]/1.6000e-01) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. TENOCoeffsMinus])
      -- BC flag
      regentlib.assert(r[c].[BCStencil] == true, ["metricTest: error in RightMinusThree Metric on " .. BCStencil])
      -- Face interpolation operator
      regentlib.assert(fabs((r[c].[interp][0]*2.0) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. interp])
      regentlib.assert(fabs((r[c].[interp][1]*2.0) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. interp])
      -- Face derivative operator
      regentlib.assert(fabs((r[c].[deriv]*r[c].cellWidth[dir]) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. deriv])
      -- Gradient operator
      regentlib.assert(fabs((r[c].[grad][0]*r[c].cellWidth[dir]*2.0) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. grad])
      regentlib.assert(fabs((r[c].[grad][1]*r[c].cellWidth[dir]*2.0) - 1.0) < 1e-3, ["metricTest: error in RightMinusThree Metric on " .. grad])
   end
end
...
local function checkRightMinusTwo(r, c, sdir)
   ...
   return rquote
      ...
      regentlib.assert(fabs((r[c].[reconPlus][Stencil2*6+2]/( 1.0/4.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusTwo Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil2*6+3]/( 5.0/4.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusTwo Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil2*6+4]/(-2.0/4.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusTwo Metric on " .. reconPlus])
      ...
      regentlib.assert(fabs((r[c].[reconPlus][Stencil4*6+2]           )      ) < 1e-3, ["metricTest: error in RightMinusTwo Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil4*6+3]           ) - 1.0) < 1e-8, ["metricTest: error in RightMinusTwo Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil4*6+4]           )      ) < 1e-8, ["metricTest: error in RightMinusTwo Metric on " .. reconPlus])
      regentlib.assert(fabs((r[c].[reconPlus][Stencil4*6+5]           )      ) < 1e-8, ["metricTest: error in RightMinusTwo Metric on " .. reconPlus])
      -- Minus side
      -- Stencil1
      ...
      regentlib.assert(fabs((r[c].[reconMinus][Stencil1*6+2]/( 1.0/4.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusTwo Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil1*6+3]/( 5.0/4.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusTwo Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil1*6+4]/(-2.0/4.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusTwo Metric on " .. reconMinus])
      ...
      regentlib.assert(fabs((r[c].[reconMinus][Stencil3*6+3]/( 2.0    )) - 1.0) < 1e-3, ["metricTest: error in RightMinusTwo Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil3*6+4]/(-1.0    )) - 1.0) < 1e-3, ["metricTest: error in RightMinusTwo Metric on " .. reconMinus])
      regentlib.assert(fabs((r[c].[reconMinus][Stencil3*6+5]           )      ) < 1e-8, ["metricTest: error in RightMinusTwo Metric on " .. reconMinus])
      -- Stencil4
      ...
      -- TENO blending coefficients
      -- Plus side
      regentlib.assert(fabs((r[c].[TENOCoeffsPlus][Stencil1]/(7.0/16.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusTwo Metric on " .. TENOCoeffsPlus])
      ...
      -- Minus side
      regentlib.assert(fabs((r[c].[TENOCoeffsMinus][Stencil1]/(2.0/4.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusTwo Metric on " .. TENOCoeffsMinus])
      regentlib.assert(fabs((r[c].[TENOCoeffsMinus][Stencil2]/(1.0/4.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusTwo Metric on " .. TENOCoeffsMinus])
      regentlib.assert(fabs((r[c].[TENOCoeffsMinus][Stencil3]          )      ) < 1e-8, ["metricTest: error in RightMinusTwo Metric on " .. TENOCoeffsMinus])
      regentlib.assert(fabs((r[c].[TENOCoeffsMinus][Stencil4]/(1.0/4.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusTwo Metric on " .. TENOCoeffsMinus])
      -- BC flag
...
local function checkRightMinusOne(r, c, sdir)
   ...
   return rquote
      ...
      regentlib.assert(fabs(r[c].[reconPlus][Stencil1*6+1]      ) < 1e-8, ["metricTest: error in RightMinusOne Metric on " .. reconPlus])
      regentlib.assert(fabs(r[c].[reconPlus][Stencil1*6+2]      ) < 1e-8, ["metricTest: error in RightMinusOne Metric on " .. reconPlus])
      regentlib.assert(fabs(r[c].[reconPlus][Stencil1*6+3] - 1.0) < 1e-3, ["metricTest: error in RightMinusOne Metric on " .. reconPlus])
      ...
      regentlib.assert(fabs(r[c].[reconPlus][Stencil2*6+2]      ) < 1e-8, ["metricTest: error in RightMinusOne Metric on " .. reconPlus])
      regentlib.assert(fabs(r[c].[reconPlus][Stencil2*6+3] - 1.0) < 1e-3, ["metricTest: error in RightMinusOne Metric on " .. reconPlus])
      ...
      -- Stencil3
      regentlib.assert(fabs(r[c].[reconPlus][Stencil3*6+0]      ) < 1e-8, ["metricTest: error in RightMinusOne Metric on " .. reconPlus])
      regentlib.assert(fabs(r[c].[reconPlus][Stencil3*6+1]      ) < 1e-8, ["metricTest: error in RightMinusOne Metric on " .. reconPlus])
      regentlib.assert(fabs(r[c].[reconPlus][Stencil3*6+2]      ) < 1e-8, ["metricTest: error in RightMinusOne Metric on " .. reconPlus])
      regentlib.assert(fabs(r[c].[reconPlus][Stencil3*6+3] - 1.0) < 1e-3, ["metricTest: error in RightMinusOne Metric on " .. reconPlus])
      ...
      regentlib.assert(fabs(r[c].[reconPlus][Stencil4*6+2]      ) < 1e-8, ["metricTest: error in RightMinusOne Metric on " .. reconPlus])
      regentlib.assert(fabs(r[c].[reconPlus][Stencil4*6+3] - 1.0) < 1e-3, ["metricTest: error in RightMinusOne Metric on " .. reconPlus])
      regentlib.assert(fabs(r[c].[reconPlus][Stencil4*6+4]      ) < 1e-8, ["metricTest: error in RightMinusOne Metric on " .. reconPlus])
      regentlib.assert(fabs(r[c].[reconPlus][Stencil4*6+5]      ) < 1e-8, ["metricTest: error in RightMinusOne Metric on " .. reconPlus])
      -- Minus side
      -- Stencil1
      ...
      -- TENO blending coefficients
      -- Plus side
      regentlib.assert(fabs((r[c].[TENOCoeffsPlus][Stencil1]/(9.0/20.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusOne Metric on " .. TENOCoeffsPlus])
      regentlib.assert(fabs((r[c].[TENOCoeffsPlus][Stencil2]/(6.0/20.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusOne Metric on " .. TENOCoeffsPlus])
      regentlib.assert(fabs((r[c].[TENOCoeffsPlus][Stencil3]/(1.0/20.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusOne Metric on " .. TENOCoeffsPlus])
      regentlib.assert(fabs((r[c].[TENOCoeffsPlus][Stencil4]/(4.0/20.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusOne Metric on " .. TENOCoeffsPlus])
      -- Minus side
      regentlib.assert(fabs((r[c].[TENOCoeffsMinus][Stencil1]/(9.0/20.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusOne Metric on " .. TENOCoeffsMinus])
      regentlib.assert(fabs((r[c].[TENOCoeffsMinus][Stencil2]/(6.0/20.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusOne Metric on " .. TENOCoeffsMinus])
      regentlib.assert(fabs((r[c].[TENOCoeffsMinus][Stencil3]/(1.0/20.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusOne Metric on " .. TENOCoeffsMinus])
      regentlib.assert(fabs((r[c].[TENOCoeffsMinus][Stencil4]/(4.0/20.0)) - 1.0) < 1e-3, ["metricTest: error in RightMinusOne Metric on " .. TENOCoeffsMinus])
      -- BC flag
      regentlib.assert(r[c].[BCStencil] == true, ["metricTest: error in RightMinusOne Metric on " .. BCStencil])
      -- Face interpolation operator
      regentlib.assert(fabs(r[c].[interp][0]       ) < 1e-8, ["metricTest: error in RightMinusOne Metric on " .. interp])
      regentlib.assert(fabs(r[c].[interp][1]  - 1.0) < 1e-3, ["metricTest: error in RightMinusOne Metric on " .. interp])
      -- Face derivative operator
      regentlib.assert(fabs((r[c].[deriv]*r[c].cellWidth[dir]*0.5) - 1.0) < 1e-3, ["metricTest: error in RightMinusOne Metric on " .. deriv])
      -- Gradient operator
      regentlib.assert(fabs((r[c].[grad][0]*r[c].cellWidth[dir]*2.0) - 1.0) < 1e-3, ["metricTest: error in RightMinusOne Metric on " .. grad])
      regentlib.assert(fabs((r[c].[grad][1]*r[c].cellWidth[dir]    ) - 1.0) < 1e-3, ["metricTest: error in RightMinusOne Metric on " .. grad])
   end
end
...
local function checkRight(r, c, sdir)
   ...
   return rquote
      ...
      -- Gradient operator
      regentlib.assert(fabs((r[c].[grad][0]*r[c].cellWidth[dir]*0.5) - 1.0) < 1e-3, ["metricTest: error in Right Metric on " .. grad])
...
task main()
   ...
   do
      ...
      [METRIC.mkCorrectGhostMetric("x")](Fluid,
                                         Fluid_bounds,
                                         SCHEMA.FlowBC_Dirichlet, SCHEMA.FlowBC_Dirichlet,
                                         xBnum, Npx);
...
regentlib.saveobj(main, "metricTest_Staggered.o", "object")
