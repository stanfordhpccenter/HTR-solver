...
local function checkLeft(r, c, sdir)
   ...
   return rquote
      ...
      regentlib.assert([cp2_d] ==   [mk_cp2], ["operatorsTest: error in Left Operators on cp2 " .. sdir])
      regentlib.assert([cp3_d] ==   [mk_cp2], ["operatorsTest: error in Left Operators on cp3 " .. sdir])
      ...
      -- Stencil2
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil2, 0)] == 0.0, ["operatorsTest: error in Left Operators on Stencil2 of Recon_Plus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil2, 1)] == 0.0, ["operatorsTest: error in Left Operators on Stencil2 of Recon_Plus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil2, 2)] == 0.0, ["operatorsTest: error in Left Operators on Stencil2 of Recon_Plus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil2, 3)] == 0.0, ["operatorsTest: error in Left Operators on Stencil2 of Recon_Plus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil2, 4)] == 0.0, ["operatorsTest: error in Left Operators on Stencil2 of Recon_Plus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil2, 5)] == 0.0, ["operatorsTest: error in Left Operators on Stencil2 of Recon_Plus_" .. sdir])
      -- Stencil3
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil3, 0)] == 0.0, ["operatorsTest: error in Left Operators on Stencil3 of Recon_Plus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil3, 1)] == 0.0, ["operatorsTest: error in Left Operators on Stencil3 of Recon_Plus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil3, 2)] == 0.0, ["operatorsTest: error in Left Operators on Stencil3 of Recon_Plus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil3, 3)] == 0.0, ["operatorsTest: error in Left Operators on Stencil3 of Recon_Plus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil3, 4)] == 0.0, ["operatorsTest: error in Left Operators on Stencil3 of Recon_Plus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil3, 5)] == 0.0, ["operatorsTest: error in Left Operators on Stencil3 of Recon_Plus_" .. sdir])
      -- Stencil4
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil4, 0)] == 0.0, ["operatorsTest: error in Left Operators on Stencil4 of Recon_Plus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil4, 1)] == 0.0, ["operatorsTest: error in Left Operators on Stencil4 of Recon_Plus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil4, 2)] == 0.0, ["operatorsTest: error in Left Operators on Stencil4 of Recon_Plus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil4, 3)] == 0.0, ["operatorsTest: error in Left Operators on Stencil4 of Recon_Plus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil4, 4)] == 0.0, ["operatorsTest: error in Left Operators on Stencil4 of Recon_Plus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil4, 5)] == 0.0, ["operatorsTest: error in Left Operators on Stencil4 of Recon_Plus_" .. sdir])
      -- Minus side
      -- Stencil1
      ...
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil1, 2)] == 0.0, ["operatorsTest: error in Left Operators on Stencil1 of Recon_Minus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil1, 3)] == 1.0, ["operatorsTest: error in Left Operators on Stencil1 of Recon_Minus_" .. sdir])
      ...
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil2, 2)] == 0.0, ["operatorsTest: error in Left Operators on Stencil2 of Recon_Minus_" .. sdir])
      ...
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil3, 2)] == 0.0, ["operatorsTest: error in Left Operators on Stencil3 of Recon_Minus_" .. sdir])
      ...
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil4, 2)] == 0.0, ["operatorsTest: error in Left Operators on Stencil4 of Recon_Minus_" .. sdir])
      ...
      -- TENO blending coefficients
      -- Plus side
      regentlib.assert([METRIC.GetCoeffs_Minus(rexpr r[c].[nType] end, Stencil1)] == 1.0, ["operatorsTest: error in Left Operators on Coeffs_Plus_" .. sdir])
      regentlib.assert([METRIC.GetCoeffs_Minus(rexpr r[c].[nType] end, Stencil2)] == 0.0, ["operatorsTest: error in Left Operators on Coeffs_Plus_" .. sdir])
      regentlib.assert([METRIC.GetCoeffs_Minus(rexpr r[c].[nType] end, Stencil3)] == 0.0, ["operatorsTest: error in Left Operators on Coeffs_Plus_" .. sdir])
      regentlib.assert([METRIC.GetCoeffs_Minus(rexpr r[c].[nType] end, Stencil4)] == 0.0, ["operatorsTest: error in Left Operators on Coeffs_Plus_" .. sdir])
      -- Minus side
      regentlib.assert([METRIC.GetCoeffs_Minus(rexpr r[c].[nType] end, Stencil1)] == 1.0, ["operatorsTest: error in Left Operators on Coeffs_Minus_" .. sdir])
      regentlib.assert([METRIC.GetCoeffs_Minus(rexpr r[c].[nType] end, Stencil2)] == 0.0, ["operatorsTest: error in Left Operators on Coeffs_Minus_" .. sdir])
      regentlib.assert([METRIC.GetCoeffs_Minus(rexpr r[c].[nType] end, Stencil3)] == 0.0, ["operatorsTest: error in Left Operators on Coeffs_Minus_" .. sdir])
      regentlib.assert([METRIC.GetCoeffs_Minus(rexpr r[c].[nType] end, Stencil4)] == 0.0, ["operatorsTest: error in Left Operators on Coeffs_Minus_" .. sdir])
      -- Node Type
      regentlib.assert(r[c].[nType] == L_C_node, ["operatorsTest: error in Left Operators on node type on " .. sdir])
      -- Staggered interpolation operator
      regentlib.assert([METRIC.GetInterp(rexpr r[c].[nType] end, 0)] == 0.5, ["operatorsTest: error in Left Operators on Interp " .. sdir])
      regentlib.assert([METRIC.GetInterp(rexpr r[c].[nType] end, 1)] == 0.5, ["operatorsTest: error in Left Operators on Interp " .. sdir])
      -- Cell-center gradient operator
      regentlib.assert([METRIC.GetGrad(rexpr r[c].[nType] end, 0)] == 0.0, ["operatorsTest: error in Left Operators on Grad " .. sdir])
      regentlib.assert([METRIC.GetGrad(rexpr r[c].[nType] end, 1)] == 1.0, ["operatorsTest: error in Left Operators on Grad " .. sdir])
      -- Kennedy order
      regentlib.assert([METRIC.GetKennedyOrder(rexpr r[c].[nType] end)] == 1, ["operatorsTest: error in Left Operators on KennedyOrder " .. sdir])
      -- Kennedy coefficients
      regentlib.assert([METRIC.GetKennedyCoeff(rexpr r[c].[nType] end, 0)] == 0.5, ["operatorsTest: error in Left Operators on KennedyCoeff " .. sdir])
...
local function checkLeftPlusOne(r, c, sdir)
   ...
   return rquote
      ...
      regentlib.assert([cp3_d] == [mk_cp2], ["operatorsTest: error in LeftPlusOne Operators on cp3 " .. sdir])
      ...
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil1, 1)] == -1.0/6.0, ["operatorsTest: error in LeftPlusOne Operators on Stencil1 of Recon_Plus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil1, 2)] ==  5.0/6.0, ["operatorsTest: error in LeftPlusOne Operators on Stencil1 of Recon_Plus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil1, 3)] ==  2.0/6.0, ["operatorsTest: error in LeftPlusOne Operators on Stencil1 of Recon_Plus_" .. sdir])
      ...
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil4, 2)] ==      0.0, ["operatorsTest: error in LeftPlusOne Operators on Stencil4 of Recon_Plus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil4, 3)] ==      0.0, ["operatorsTest: error in LeftPlusOne Operators on Stencil4 of Recon_Plus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil4, 4)] ==      0.0, ["operatorsTest: error in LeftPlusOne Operators on Stencil4 of Recon_Plus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil4, 5)] ==      0.0, ["operatorsTest: error in LeftPlusOne Operators on Stencil4 of Recon_Plus_" .. sdir])
      -- Minus side
      -- Stencil1
      ...
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil2, 1)] == -1.0/6.0, ["operatorsTest: error in LeftPlusOne Operators on Stencil2 of Recon_Minus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil2, 2)] ==  5.0/6.0, ["operatorsTest: error in LeftPlusOne Operators on Stencil2 of Recon_Minus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil2, 3)] ==  2.0/6.0, ["operatorsTest: error in LeftPlusOne Operators on Stencil2 of Recon_Minus_" .. sdir])
      ...
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil3, 3)] ==      0.0, ["operatorsTest: error in LeftPlusOne Operators on Stencil3 of Recon_Minus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil3, 4)] ==      0.0, ["operatorsTest: error in LeftPlusOne Operators on Stencil3 of Recon_Minus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil3, 5)] ==      0.0, ["operatorsTest: error in LeftPlusOne Operators on Stencil3 of Recon_Minus_" .. sdir])
      -- Stencil4
      ...
      -- TENO blending coefficients
      -- Plus side
      regentlib.assert([METRIC.GetCoeffs_Plus(rexpr r[c].[nType] end, Stencil1)] == 0.5, ["operatorsTest: error in LeftPlusOne Operators on Coeffs_Plus_" .. sdir])
      regentlib.assert([METRIC.GetCoeffs_Plus(rexpr r[c].[nType] end, Stencil2)] == 0.5, ["operatorsTest: error in LeftPlusOne Operators on Coeffs_Plus_" .. sdir])
      ...
      regentlib.assert([METRIC.GetCoeffs_Plus(rexpr r[c].[nType] end, Stencil4)] == 0.0, ["operatorsTest: error in LeftPlusOne Operators on Coeffs_Plus_" .. sdir])
      -- Minus side
      regentlib.assert([METRIC.GetCoeffs_Minus(rexpr r[c].[nType] end, Stencil1)] == 0.5, ["operatorsTest: error in LeftPlusOne Operators on Coeffs_Minus_" .. sdir])
      regentlib.assert([METRIC.GetCoeffs_Minus(rexpr r[c].[nType] end, Stencil2)] == 0.5, ["operatorsTest: error in LeftPlusOne Operators on Coeffs_Minus_" .. sdir])
      regentlib.assert([METRIC.GetCoeffs_Minus(rexpr r[c].[nType] end, Stencil3)] == 0.0, ["operatorsTest: error in LeftPlusOne Operators on Coeffs_Minus_" .. sdir])
      ...
      -- Node Type
      regentlib.assert(r[c].[nType] == Lp1_C_node, ["operatorsTest: error in LeftPlusOne Operators on node type on " .. sdir])
      -- Staggered interpolation operator
      ...
      -- Cell-center gradient operator
      regentlib.assert([METRIC.GetGrad(rexpr r[c].[nType] end, 0)] == 0.5, ["operatorsTest: error in LeftPlusOne Operators on Grad " .. sdir])
      regentlib.assert([METRIC.GetGrad(rexpr r[c].[nType] end, 1)] == 0.5, ["operatorsTest: error in LeftPlusOne Operators on Grad " .. sdir])
      -- Kennedy order
      regentlib.assert([METRIC.GetKennedyOrder(rexpr r[c].[nType] end)] == 2, ["operatorsTest: error in LeftPlusOne Operators on KennedyOrder " .. sdir])
      -- Kennedy coefficients
      regentlib.assert([METRIC.GetKennedyCoeff(rexpr r[c].[nType] end, 0)] ==   2.0/3.0, ["operatorsTest: error in LeftPlusOne Operators on KennedyCoeff " .. sdir])
      regentlib.assert([METRIC.GetKennedyCoeff(rexpr r[c].[nType] end, 1)] == -1.0/12.0, ["operatorsTest: error in LeftPlusOne Operators on KennedyCoeff " .. sdir])
...
local function checkRightMinusTwo(r, c, sdir)
   ...
   return rquote
      -- Stencil indices
      regentlib.assert([cm2_d] == [mk_cm1], ["operatorsTest: error in RightMinusTwo Operators on cm2 " .. sdir])
      ...
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil2, 2)] ==  2.0/6.0, ["operatorsTest: error in RightMinusTwo Operators on Stencil2 of Recon_Plus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil2, 3)] ==  5.0/6.0, ["operatorsTest: error in RightMinusTwo Operators on Stencil2 of Recon_Plus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil2, 4)] == -1.0/6.0, ["operatorsTest: error in RightMinusTwo Operators on Stencil2 of Recon_Plus_" .. sdir])
      ...
      -- Stencil3
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil3, 0)] ==      0.0, ["operatorsTest: error in RightMinusTwo Operators on Stencil3 of Recon_Plus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil3, 1)] ==      0.0, ["operatorsTest: error in RightMinusTwo Operators on Stencil3 of Recon_Plus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil3, 2)] ==      0.0, ["operatorsTest: error in RightMinusTwo Operators on Stencil3 of Recon_Plus_" .. sdir])
      ...
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil1, 2)] ==  2.0/6.0, ["operatorsTest: error in RightMinusTwo Operators on Stencil1 of Recon_Minus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil1, 3)] ==  5.0/6.0, ["operatorsTest: error in RightMinusTwo Operators on Stencil1 of Recon_Minus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil1, 4)] == -1.0/6.0, ["operatorsTest: error in RightMinusTwo Operators on Stencil1 of Recon_Minus_" .. sdir])
      ...
      -- Stencil4
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil4, 0)] ==      0.0, ["operatorsTest: error in RightMinusTwo Operators on Stencil4 of Recon_Minus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil4, 1)] ==      0.0, ["operatorsTest: error in RightMinusTwo Operators on Stencil4 of Recon_Minus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil4, 2)] ==      0.0, ["operatorsTest: error in RightMinusTwo Operators on Stencil4 of Recon_Minus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil4, 3)] ==      0.0, ["operatorsTest: error in RightMinusTwo Operators on Stencil4 of Recon_Minus_" .. sdir])
      ...
      -- TENO blending coefficients
      -- Plus side
      regentlib.assert([METRIC.GetCoeffs_Plus(rexpr r[c].[nType] end, Stencil1)] == 0.5, ["operatorsTest: error in RightMinusTwo Operators on Coeffs_Plus_" .. sdir])
      regentlib.assert([METRIC.GetCoeffs_Plus(rexpr r[c].[nType] end, Stencil2)] == 0.5, ["operatorsTest: error in RightMinusTwo Operators on Coeffs_Plus_" .. sdir])
      regentlib.assert([METRIC.GetCoeffs_Plus(rexpr r[c].[nType] end, Stencil3)] == 0.0, ["operatorsTest: error in RightMinusTwo Operators on Coeffs_Plus_" .. sdir])
      ...
      -- Minus side
      regentlib.assert([METRIC.GetCoeffs_Minus(rexpr r[c].[nType] end, Stencil1)] == 0.5, ["operatorsTest: error in RightMinusTwo Operators on Coeffs_Minus_" .. sdir])
      regentlib.assert([METRIC.GetCoeffs_Minus(rexpr r[c].[nType] end, Stencil2)] == 0.5, ["operatorsTest: error in RightMinusTwo Operators on Coeffs_Minus_" .. sdir])
      ...
      regentlib.assert([METRIC.GetCoeffs_Minus(rexpr r[c].[nType] end, Stencil4)] == 0.0, ["operatorsTest: error in RightMinusTwo Operators on Coeffs_Minus_" .. sdir])
      -- Node Type
      regentlib.assert(r[c].[nType] == Rm2_C_node, ["operatorsTest: error in RightMinusTwo Operators on node type on " .. sdir])
      -- Staggered interpolation operator
      ...
      -- Kennedy order
      regentlib.assert([METRIC.GetKennedyOrder(rexpr r[c].[nType] end)] == 2, ["operatorsTest: error in RightMinusTwo Operators on KennedyOrder " .. sdir])
      -- Kennedy coefficients
      regentlib.assert([METRIC.GetKennedyCoeff(rexpr r[c].[nType] end, 0)] ==   2.0/3.0, ["operatorsTest: error in RightMinusTwo Operators on KennedyCoeff " .. sdir])
      regentlib.assert([METRIC.GetKennedyCoeff(rexpr r[c].[nType] end, 1)] == -1.0/12.0, ["operatorsTest: error in RightMinusTwo Operators on KennedyCoeff " .. sdir])
...
local function checkRightMinusOne(r, c, sdir)
   ...
   return rquote
      ...
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil1, 2)] == 1.0, ["operatorsTest: error in RightMinusOne Operators on Stencil1 of Recon_Plus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil1, 3)] == 0.0, ["operatorsTest: error in RightMinusOne Operators on Stencil1 of Recon_Plus_" .. sdir])
      ...
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil2, 3)] == 0.0, ["operatorsTest: error in RightMinusOne Operators on Stencil2 of Recon_Plus_" .. sdir])
      ...
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil3, 3)] == 0.0, ["operatorsTest: error in RightMinusOne Operators on Stencil3 of Recon_Plus_" .. sdir])
      ...
      regentlib.assert([METRIC.GetRecon_Plus(rexpr r[c].[nType] end, Stencil4, 3)] == 0.0, ["operatorsTest: error in RightMinusOne Operators on Stencil4 of Recon_Plus_" .. sdir])
      ...
      -- Stencil2
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil2, 0)] == 0.0, ["operatorsTest: error in RightMinusOne Operators on Stencil2 of Recon_Minus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil2, 1)] == 0.0, ["operatorsTest: error in RightMinusOne Operators on Stencil2 of Recon_Minus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil2, 2)] == 0.0, ["operatorsTest: error in RightMinusOne Operators on Stencil2 of Recon_Minus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil2, 3)] == 0.0, ["operatorsTest: error in RightMinusOne Operators on Stencil2 of Recon_Minus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil2, 4)] == 0.0, ["operatorsTest: error in RightMinusOne Operators on Stencil2 of Recon_Minus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil2, 5)] == 0.0, ["operatorsTest: error in RightMinusOne Operators on Stencil2 of Recon_Minus_" .. sdir])
      -- Stencil3
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil3, 0)] == 0.0, ["operatorsTest: error in RightMinusOne Operators on Stencil3 of Recon_Minus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil3, 1)] == 0.0, ["operatorsTest: error in RightMinusOne Operators on Stencil3 of Recon_Minus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil3, 2)] == 0.0, ["operatorsTest: error in RightMinusOne Operators on Stencil3 of Recon_Minus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil3, 3)] == 0.0, ["operatorsTest: error in RightMinusOne Operators on Stencil3 of Recon_Minus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil3, 4)] == 0.0, ["operatorsTest: error in RightMinusOne Operators on Stencil3 of Recon_Minus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil3, 5)] == 0.0, ["operatorsTest: error in RightMinusOne Operators on Stencil3 of Recon_Minus_" .. sdir])
      -- Stencil4
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil4, 0)] == 0.0, ["operatorsTest: error in RightMinusOne Operators on Stencil4 of Recon_Minus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil4, 1)] == 0.0, ["operatorsTest: error in RightMinusOne Operators on Stencil4 of Recon_Minus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil4, 2)] == 0.0, ["operatorsTest: error in RightMinusOne Operators on Stencil4 of Recon_Minus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil4, 3)] == 0.0, ["operatorsTest: error in RightMinusOne Operators on Stencil4 of Recon_Minus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil4, 4)] == 0.0, ["operatorsTest: error in RightMinusOne Operators on Stencil4 of Recon_Minus_" .. sdir])
      regentlib.assert([METRIC.GetRecon_Minus(rexpr r[c].[nType] end, Stencil4, 5)] == 0.0, ["operatorsTest: error in RightMinusOne Operators on Stencil4 of Recon_Minus_" .. sdir])
      -- TENO blending coefficients
      -- Plus side
      regentlib.assert([METRIC.GetCoeffs_Minus(rexpr r[c].[nType] end, Stencil1)] == 1.0, ["operatorsTest: error in RightMinusOne Operators on Coeffs_Plus_" .. sdir])
      regentlib.assert([METRIC.GetCoeffs_Minus(rexpr r[c].[nType] end, Stencil2)] == 0.0, ["operatorsTest: error in RightMinusOne Operators on Coeffs_Plus_" .. sdir])
      regentlib.assert([METRIC.GetCoeffs_Minus(rexpr r[c].[nType] end, Stencil3)] == 0.0, ["operatorsTest: error in RightMinusOne Operators on Coeffs_Plus_" .. sdir])
      regentlib.assert([METRIC.GetCoeffs_Minus(rexpr r[c].[nType] end, Stencil4)] == 0.0, ["operatorsTest: error in RightMinusOne Operators on Coeffs_Plus_" .. sdir])
      -- Minus side
      regentlib.assert([METRIC.GetCoeffs_Minus(rexpr r[c].[nType] end, Stencil1)] == 1.0, ["operatorsTest: error in RightMinusOne Operators on Coeffs_Minus_" .. sdir])
      regentlib.assert([METRIC.GetCoeffs_Minus(rexpr r[c].[nType] end, Stencil2)] == 0.0, ["operatorsTest: error in RightMinusOne Operators on Coeffs_Minus_" .. sdir])
      regentlib.assert([METRIC.GetCoeffs_Minus(rexpr r[c].[nType] end, Stencil3)] == 0.0, ["operatorsTest: error in RightMinusOne Operators on Coeffs_Minus_" .. sdir])
      regentlib.assert([METRIC.GetCoeffs_Minus(rexpr r[c].[nType] end, Stencil4)] == 0.0, ["operatorsTest: error in RightMinusOne Operators on Coeffs_Minus_" .. sdir])
      -- Node Type
      regentlib.assert(r[c].[nType] == Rm1_C_node, ["operatorsTest: error in RightMinusOne Operators on node type on " .. sdir])
      -- Staggered interpolation operator
      regentlib.assert([METRIC.GetInterp(rexpr r[c].[nType] end, 0)] == 0.5, ["operatorsTest: error in RightMinusOne Operators on Interp " .. sdir])
      regentlib.assert([METRIC.GetInterp(rexpr r[c].[nType] end, 1)] == 0.5, ["operatorsTest: error in RightMinusOne Operators on Interp " .. sdir])
      -- Cell-center gradient operator
      regentlib.assert([METRIC.GetGrad(rexpr r[c].[nType] end, 0)] == 0.5, ["operatorsTest: error in RightMinusOne Operators on Grad " .. sdir])
      regentlib.assert([METRIC.GetGrad(rexpr r[c].[nType] end, 1)] == 0.5, ["operatorsTest: error in RightMinusOne Operators on Grad " .. sdir])
      -- Kennedy order
      regentlib.assert([METRIC.GetKennedyOrder(rexpr r[c].[nType] end)] == 1, ["operatorsTest: error in RightMinusOne Operators on KennedyOrder " .. sdir])
      -- Kennedy coefficients
      regentlib.assert([METRIC.GetKennedyCoeff(rexpr r[c].[nType] end, 0)] == 0.5, ["operatorsTest: error in RightMinusOne Operators on KennedyCoeff " .. sdir])
...
local function checkRight(r, c, sdir)
   ...
   return rquote
      ...
      -- Node Type
      regentlib.assert(r[c].[nType] == R_C_node, ["operatorsTest: error in Right Operators on node type on " .. sdir])
      -- Staggered interpolation operator
      ...
      -- Cell-center gradient operator
      regentlib.assert([METRIC.GetGrad(rexpr r[c].[nType] end, 0)] == 1.0, ["operatorsTest: error in Right Operators on Grad " .. sdir])
...
task main()
   ...
   C.printf("operatorsTest_Collocated: run...")
   ...
   for c in tiles do [METRIC.mkCorrectGhostOperators("x")](p_Fluid[c], Fluid_bounds, SCHEMA.FlowBC_NSCBC_Inflow, SCHEMA.FlowBC_NSCBC_Inflow, xBnum, Npx) end
   __demand(__index_launch)
   for c in tiles do [METRIC.mkCorrectGhostOperators("y")](p_Fluid[c], Fluid_bounds, SCHEMA.FlowBC_NSCBC_Inflow, SCHEMA.FlowBC_NSCBC_Inflow, yBnum, Npy) end
   __demand(__index_launch)
   for c in tiles do [METRIC.mkCorrectGhostOperators("z")](p_Fluid[c], Fluid_bounds, SCHEMA.FlowBC_NSCBC_Inflow, SCHEMA.FlowBC_NSCBC_Inflow, zBnum, Npz) end

   checkOperators(Fluid)

   __fence(__execution, __block)

   C.printf("operatorsTest_Collocated: TEST OK!\n")
end
...
regentlib.saveobj(main, "operatorsTest_Collocated.o", "object")
